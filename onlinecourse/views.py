...
def submit(request, course_id):
    ...
    a_submission.enrollment = enrollment 
    a_submission.save()
    for a_choice in submitted_answers:           
        a_submission.choices.add(Choice.objects.get(pk=a_choice))

    return HttpResponseRedirect(reverse(viewname='onlinecourse:show_exam_result', args=(course.id,a_submission.id)))
